...
public class TimelineTemplateTest extends AbstractTwitterApiTest {
	...
	public void updateStatus() {
		mockServer.expect(requestTo("https://api.twitter.com/1.1/statuses/update.json?tweet_mode=extended"))
	...
	@Test
	public void retweet() {
		mockServer.expect(requestTo("https://api.twitter.com/1.1/statuses/retweet/363048052157726721.json?tweet_mode=extended"))
				.andExpect(method(POST))
	...
	public void retweet_duplicateTweet() {
		mockServer.expect(requestTo("https://api.twitter.com/1.1/statuses/retweet/12345.json?tweet_mode=extended"))
				.andExpect(method(POST))
				.andRespond(withStatus(FORBIDDEN).body("{\"error\":\"You already said that\"}").contentType(APPLICATION_JSON));
